...
(function (P3_2) {
    var formData;
    var url = "https://mainscript-gis.herokuapp.com/";
    var type = "";
    var htmlSubmit = document.getElementById("htmlsubmit");
    var jsonSubmit = document.getElementById("jsonsubmit");
    ...
    function handleSubmit() {
        return __awaiter(this, void 0, void 0, function () {
            var query, response, responseString, responseJSON, frag;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (type == "json") {
                            ...
                            frag = document.createRange().createContextualFragment(responseString);
