...
(function (Aufgabe2) {
    ...
    var student1 = { nachname: "Shinomiya", vorname: "Kaguya", matrikelnummer: "177013", semester: 3, studiengang: "MKB" };
    var student2 = { nachname: "Shirogane", vorname: "Miyuki", matrikelnummer: "420690", semester: 3, studiengang: "MIB" };
    var student3 = { nachname: "Fujiwara", vorname: "Chika", matrikelnummer: "123456", semester: 3, studiengang: "OMB" };
    var StuArrOld = [student1, student2, student3];
    ...
    for (var _i = 0, StuArrOld_1 = StuArrOld; _i < StuArrOld_1.length; _i++) {
        var student = StuArrOld_1[_i];
        showInfoOld(student);
    }
    /////////////////////////////////////////////////////////////////////////////////////////////////////
    // Klasse:
    var Studierender = /** @class */ (function () {
        function Studierender(_nachname, _vorname, _matrikelnummer, _semester, _studiengang) {
        ...
        Studierender.prototype.showInfo = function () {
    ...
    function join() {
        ...
        for (var _a = 0, array_1 = array; _a < array_1.length; _a++) {
            var arr_2 = array_1[_a];
            for (var _b = 0, arr_1 = arr_2; _b < arr_1.length; _b++) {
                var num = arr_1[_b];
                out.push(num);
            }
        }
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    // Testcode:
    var arr = [5, 42, 17, 2018, -10, 60, -10010];
    var arrBack = backwards(arr);
    console.log(arr);
    console.log(arrBack);
    ...
    window.addEventListener("load", function () {
        ...
        var scale = 2;
        var Zeichenobjekt = /** @class */ (function () {
            function Zeichenobjekt(_x, _y, _w, _h, _fc) {
                this.position = [];
                this.dimensions = [];
                this.velocity = [];
                this.position[0] = _x;
            ...
            Zeichenobjekt.prototype.move = function () {
                this.checkforWall();
                this.position[0] += this.velocity[0];
                this.position[1] += this.velocity[1];
            };
            Zeichenobjekt.prototype.checkforWall = function () {
                var canvasdimensions = [canvas2.width, canvas2.height];
                for (var i = 0; i < 2; i++) {
            ...
            return Zeichenobjekt;
        }());
        var Rectangle = /** @class */ (function (_super) {
            __extends(Rectangle, _super);
            function Rectangle(_x, _y, _w, _h, _fc) {
                var _this = this;
                if (_fc != undefined) {
                    _this = _super.call(this, _x, _y, _w, _h, _fc) || this;
                }
                else {
                    _this = _super.call(this, _x, _y, _w, _h) || this;
                }
                return _this;
            }
            ;
        ...
        var Kreis = /** @class */ (function (_super) {
            __extends(Kreis, _super);
            function Kreis(_x, _y, d, _fc) {
                var _this = this;
                if (_fc != undefined) {
                    _this = _super.call(this, _x, _y, d, d, _fc) || this;
                }
                else {
                    _this = _super.call(this, _x, _y, d, d) || this;
                }
                return _this;
            }
            Kreis.prototype.drawCircle = function () {
                context2.beginPath();
        ...
        var rectArray = [];
        var anzahlObjekte = 20;
        var h = canvas2.height / anzahlObjekte;
        var fps = 60;
        var circArray = [];
        for (var i = 0; i < anzahlObjekte / 2; i++) {
            var rect = new Rectangle(0, i * h * 2, Math.floor(Math.random() * canvas2.width), h);
            rectArray.push(rect);
        }
        for (var i = 0; i < anzahlObjekte / 2; i++) {
            var r = Math.random() * 100;
            var circ = new Kreis(r * 2, i * r * 2, r);
            circArray.push(circ);
        }
        setInterval(function () {
            context2.clearRect(0, 0, canvas2.width, canvas2.height);
            for (var _i = 0, rectArray_1 = rectArray; _i < rectArray_1.length; _i++) {
                var rect = rectArray_1[_i];
                rect.move();
                rect.drawRect();
            }
            for (var _a = 0, circArray_1 = circArray; _a < circArray_1.length; _a++) {
                var circ = circArray_1[_a];
                circ.move();
                circ.drawCircle();
            }
        }, 1 / fps);
    });
    function drawPath(arr, _context) {
        _context.beginPath();
