...
(function (Aufgabe2) {
    ...
    let student1 = { nachname: "Shinomiya", vorname: "Kaguya", matrikelnummer: "177013", semester: 3, studiengang: "MKB" };
    let student2 = { nachname: "Shirogane", vorname: "Miyuki", matrikelnummer: "420690", semester: 3, studiengang: "MIB" };
    let student3 = { nachname: "Fujiwara", vorname: "Chika", matrikelnummer: "123456", semester: 3, studiengang: "OMB" };
    let StuArrOld = [student1, student2, student3];
    ...
    // Klasse:
    class Studierender {
        constructor(_nachname, _vorname, _matrikelnummer, _semester, _studiengang) {
    ...
    let studentNEW = new Studierender("Gawr", "Gura", "14147", 9000, "MKB");
    studentNEW.showInfo();
    ...
    window.addEventListener("load", function () {
        ...
        class Zeichenobjekt {
            ...
            checkforWall() {
                let canvasdimensions = [canvas2.width, canvas2.height];
                for (let i = 0; i < 2; i++) {
        ...
        let rectArray = [];
        let anzahlObjekte = 20;
        let h = canvas2.height / anzahlObjekte;
        let fps = 60;
        let circArray = [];
        for (let i = 0; i < anzahlObjekte / 2; i++) {
            let rect = new Rectangle(0, i * h * 2, Math.floor(Math.random() * canvas2.width), h);
            rectArray.push(rect);
        }
        for (let i = 0; i < anzahlObjekte / 2; i++) {
            let r = Math.random() * 100;
            let circ = new Kreis(r * 2, i * r * 2, r);
            circArray.push(circ);
        }
